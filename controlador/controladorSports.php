<?php
    require 'modelo/modeloSports.php';
    require 'modelo/sports.php';
    require_once 'config.php';

    session_status() === PHP_SESSION_ACTIVE ? TRUE : session_start();
    
	class controladorSports 
	{

 		function __construct() 
		{          
			$this->objconfig = new config();
			$this->objsm =  new modeloSports($this->objconfig);
		}
        // mvc handler request
            ...
            try{
                ...
                {   
                    ...
                    {    
                        ...
                        $this->pageRedirect("vista/vistaInsertar.php");                
                    }
                }
            }catch (Exception $e) 
            {
            ...
            try
            {
                ...
                if (isset($_POST['updatebtn'])) 
                {
                    ...
                    {         
                        ...
                        $this->pageRedirect("vista/vistaActualizar.php");                
                    }
